    ...
    describe('Logged out user', function() {
      ...
      describe('askForPasswordReset', function() {
        ...
        describe('POST error', function() {
          ...
          beforeEach(function() {
            $httpBackend.when('POST', '/api/forgot', credentials).respond(400, {
        ...
        describe('POST success', function() {
          ...
          beforeEach(function() {
            $httpBackend.when('POST', '/api/forgot', credentials).respond({
      ...
      describe('resetUserPassword', function() {
        ...
        it('POST error should call Notification.error with response message', function() {
          ...
          $httpBackend.when('POST', '/api/reset/' + token, passwordDetails).respond(400, {
            'message': errorMessage
          });
        ...
        describe('POST success', function() {
          ...
          beforeEach(function() {
            $httpBackend.when('POST', '/api/reset/' + token, passwordDetails).respond(user);
